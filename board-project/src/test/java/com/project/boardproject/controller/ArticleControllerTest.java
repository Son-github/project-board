...
import com.project.boardproject.dto.response.ArticleResponse;
import com.project.boardproject.service.ArticleService;
import com.project.boardproject.service.PaginationService;
import com.project.boardproject.util.FormDataEncoder;
...
@WebMvcTest(ArticleController.class) // 입력한 컨트롤러만 가지고 테스트
class ArticleControllerTest {
    ...
    public void givenNothing_whenRequestingArticlesView_thenReturnArticlesView() throws Exception {
        ...
        mvc.perform(get("/articles"))
                ...
                .andExpect(model().attributeExists("paginationBarNumbers")); // articles라는 값을 하나 넘겨주어야함
    ...
    @WithMockUser // 인증 정보를 받아서 수행하는 일이 없을 때에는 인증됐다고 시그널을 보낼 수 있음.
    ...
    public void givenNothing_whenRequestingArticleView_thenReturnArticleView() throws Exception {
        ...
        Long articleId = 1L;
        long totalCount = 1L;
        given(articleService.getArticleWithComments(articleId)).willReturn(createArticleWithComments());
    ...
    @WithUserDetails(value = "unoTest",setupBefore = TestExecutionEvent.TEST_EXECUTION) // 유저 정보가 하나가 아닐 때에는 userDetailsServiceBeanName = "userDetailsService"를 넣어 찾아야 한다.
    ...
    @Test
    void givenNothing_whenRequesting_thenRediretsToLoginPage() throws Exception {
        // Given
        long articleId = 1L;
